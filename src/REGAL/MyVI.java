...
public class MyVI extends ValueFunctionPlanner{
	...
	/**
	 * When the VI sotps, it stores the number of iterations which is used to approximate the bias vector
	 * */
	...
	public void runVI(){
		...
		for(i = 0; i < this.maxIterations; i++){
			...
			/*if(delta < this.maxDelta){
				//System.out.println("Stop!! delta="+delta);
	...
	/**
	 * @param optimalGain the optimalGain to set
	 */
